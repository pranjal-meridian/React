          ...
          {!imageCaptured ? (
            <div className="text-center">
              <button 
                ...
                className="w-40 h-40 bg-white/20 rounded-full flex flex-col items-center justify-center hover:bg-white/30 backdrop-blur-sm transition-all duration-300 border-2 border-white/50 shadow-xl"
              >
            ...
            <div className="text-center">
              <div className="w-40 h-40 bg-white/20 rounded-full flex items-center justify-center border-2 border-white/50 shadow-xl overflow-hidden">
                <img src="/api/placeholder/160/160" alt="Profile preview" className="object-cover w-full h-full" />
              </div>
